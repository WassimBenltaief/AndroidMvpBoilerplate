...
# and specify the fully qualified class todo to the JavaScript interface
# class:
...
-keepclassmembers class com.wassim.androidmvpbase.data.model.** {
...
-keepclassmembers class com.wassim.androidmvpbase.data.remote.ApiService$** {
    !static !private <fields>;
}
